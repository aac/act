...
// alias is cheap insurance for any in-flight callers still using the old
// name during the rename. It prints a notice to stderr and delegates to
// runStateExport with the identical argument vector — same flags, same
// behavior.
