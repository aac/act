...
//
// The load-bearing test (TestBootstrapFromCWD_ExternalWorkerEndToEnd)
// exercises the full external-worker round trip end-to-end and asserts
...
// TestBootstrapFromCWD_ExternalWorkerEndToEnd is the load-bearing
...
func TestBootstrapFromCWD_ExternalWorkerEndToEnd(t *testing.T) {
	if actBinaryPath == "" {
