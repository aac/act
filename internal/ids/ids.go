...
// protocol described in spec.md §ID model.
//
...
// giving up.
//
// The 16-hex cap is authoritative per docs/spec.md §ID model and the
...
type CreatePayload struct {
	...
	// byte-identical canonical JSON to before the field existed, so no
...
// docs/spec.md §ID model and matches MaxShortHexLen. The lower bound (4)
